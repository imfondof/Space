...
import 'package:echart/landscape_page.dart';
...
import 'liquid_script.dart';
import 'wordcloud_script.dart';
...
class MyHomePageState extends State<EchartPage> {
    ...
    series: [{
        ...
        emphasis: {
            ...
            itemStyle: {
              ...
              const Padding(
                padding: EdgeInsets.fromLTRB(0, 40, 0, 0),
                child: Text('pie-roseType', style: TextStyle(fontSize: 20)),
              ),
              SizedBox(
                width: 300,
                height: 250,
  ...
  void jump() {
    ...
    Navigator.push(context, MaterialPageRoute(builder: (context)=>const LandscapePage())).then((value){
      // SystemChrome.setPreferredOrientations([
